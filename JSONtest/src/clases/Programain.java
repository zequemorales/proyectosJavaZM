...
//		System.out.println(ListadoCopiaPersonas.toString());
		...
		ClaseGenerica<Integer> objPrueba = new ClaseGenerica<Integer>();
		objPrueba.setObj(10);
		objPrueba.tipoDeClase();
		
		
		ClaseGenerica<String> objPrueba2 = new ClaseGenerica<String>();
		objPrueba2.setObj("hola");
		objPrueba2.tipoDeClase();
		
		System.out.println(objPrueba2.hola());
		
		System.out.println(objPrueba.getObj());
		System.out.println(objPrueba2.getObj());
